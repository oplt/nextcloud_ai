...
Revision ID: ff16b1e1c386
Revises: 
Create Date: 2026-03-08 03:36:11.222195
...
def upgrade() -> None:
    ...
    sa.Column('allowed_user_ids', sa.ARRAY(sa.String()), nullable=False),
    sa.Column('allowed_group_ids', sa.ARRAY(sa.String()), nullable=False),
